...
export const IconFitFlowLogo = ({ className = "w-7 h-7" }) => (
  <svg className={className} viewBox="0 0 32 32" fill="none">
    <path
      d="M5 16C8 10 13 8 18 10C24 12.5 27 9 29 7"
      stroke="#584CF4"
      strokeWidth="3.5"
      strokeLinecap="round"
    />
    <path
      d="M3 21C6 15 11 13 16 15C22 17.5 25 14 27 12"
      stroke="#7C3AED"
      strokeWidth="3.5"
      strokeLinecap="round"
      strokeOpacity="0.8"
...
export const IconSteps = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 16v-2.38C4 11.5 7 11 9 11s5 .5 5 2.62V16"/>
    <path d="M14 13.5c1.5-.5 3.5-.5 5 1V18"/>
    <circle cx="8.5" cy="5.5" r="2.5"/>
    <circle cx="17.5" cy="8.5" r="2.5"/>
  </svg>
);

export const IconDumbbell = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconTrainer = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconApple = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconRotateCcw = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconSmartphone = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconMonitor = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
