        ...
        <div className="flex items-center space-x-2.5 sm:space-x-3 truncate">
          ...
          <div className="truncate">
            <h1 className="text-xs sm:text-sm font-black text-slate-900 tracking-tight flex items-center space-x-1.5 sm:space-x-2 truncate">
              <span className="truncate">{currentUser?.gymName || 'Gym Management'}</span>
            ...
            <p className="text-[10px] sm:text-xs text-slate-500 truncate">Coach: {currentUser?.userName || 'Trainer'}</p>
          </div>
        </div>
      ...
      <main className="p-3 sm:p-6 max-w-7xl mx-auto space-y-4 sm:space-y-6">
        ...
        <div className="p-4 sm:p-6 rounded-2xl sm:rounded-3xl bg-white border border-slate-200/80 shadow-sm space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 sm:pb-4 border-b border-slate-100">
            <div>
              <h3 className="text-sm sm:text-base font-black text-slate-900">Gym Members & Trainees</h3>
              <p className="text-[11px] sm:text-xs text-slate-500">View member workout status & plan validity</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:space-x-3 w-full sm:w-auto">
              <input
                ...
                className="w-full sm:w-56 px-3.5 py-1.5 bg-white border border-slate-200 rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500"
              />

              <div className="flex space-x-1 bg-slate-100/80 p-1 rounded-xl border border-slate-200 overflow-x-auto self-start sm:self-auto">
                ...
                {members.map((m) => (
                  ...
                  >
                    ...
                    <div className="flex justify-end pt-1 border-t border-slate-200/60">
                      <button
                        onClick={() => setViewingMember(m)}
                        className="px-3 py-1 bg-white hover:bg-slate-100 text-cyan-700 border border-cyan-200 rounded-lg text-xs font-bold shadow-2xs"
                      >
                        View Pass
                      </button>
                    </div>
